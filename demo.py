...
ds = WeightDriftStream(130000, 120, dist_support=[0, 7], seed=1)
...
train_idx = range(80000)
x_train = ds.x[train_idx]
# t_train = ds.t[train_idx]
t_train = np.arange(1, 80001)
# test_idx = range(train_idx[-1] + 1, ds.x.shape[0])
test_idx = range(80001, 120001)
x_test = ds.x[test_idx]
# t_test = ds.t[test_idx]
t_test = np.arange(80001, 120001)
t_test_real = ds.t[test_idx]
...
model.fit(x_train[70000:80000], t_train[70000:80000])
# model.fit(x_train, t_train)
orig_timestamps = t_train
#for x_part, t_part in get_every_n(x_train, t_train, n=10000):
